...
def load_test_slices(file_path, num_slices=64, slice_size_kb=4):
    """
...
if __name__ == "__main__":
    ...
    training_files = {
        #"clude": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\traning\B2-clude.txt",
        "Google": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\traning\B2-google.txt",
        #"Deepseek": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\traning\B2-deepseek.txt",
        #"Gimini": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\traning\B2-Gemni.txt",
        "Microsoft": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\traning\B2-Bing.txt",
        #"GPT": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\traning\B2-GPT.txt",
    ...
    test_files = {
        #"clude": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\test\B2-clude.txt",
        "Google": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\test\B2-google.txt",
        #"Deepseek": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\test\B2-deepseek.txt",
        #"Gimini": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\test\B2-Gemini.txt",
        "Microsoft": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\test\B2-Bing.txt",
        #"GPT": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\C-R\test\B2-GPT.txt"
    ...
    training_data_map = {
        author: load_text(file_path, 32) for author, file_path in training_files.items()
    }

    # Load test slices (16 slices per file, 4 kB each)
    test_slices = {
        author: load_test_slices(file_path, num_slices=16 , slice_size_kb=2) for author, file_path in test_files.items()
    }
