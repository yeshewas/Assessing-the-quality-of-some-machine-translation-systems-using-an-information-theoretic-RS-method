...
def load_test_slices(file_path, num_slices=32, slice_size_kb=2):
    """
...
if __name__ == "__main__":
    ...
    training_files = {
        #"clude": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\traning\B1-clude.txt",
        #"Google": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\traning\B1-Google.txt",
        "Deepseek": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\traning\B1-Deepseek.txt",
        #"Gimini": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\traning\B1-Gemini.txt",
        "Microsoft": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\traning\B1-microsoft.txt",
        #"GPT": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\traning\B1-GPT.txt"
    ...
    test_files = {
        #"clude": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\test\B1-clude.txt",
        #"Google": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\test\B1-Google.txt",
        "Deepseek": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\test\B1-Deepseek.txt",
        #"Gimini": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\test\B1-Gemini.txt",
        "Microsoft": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\test\B1-microsoft.txt",
        #"GPT": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\E-R\test\B1-GPT.txt"
    ...
    training_data_map = {
        author: load_text(file_path, 105) for author, file_path in training_files.items()
    }

    # Load test slices (16 slices per file, 4 kB each)
    test_slices = {
        author: load_test_slices(file_path, num_slices=16, slice_size_kb=4) for author, file_path in test_files.items()
    }
