...
if __name__ == "__main__":
    ...
    training_files = {
        "clude": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\traning\B1-clude.txt",
        #"Google": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\traning\B2-Google.txt",
        "Deepseek": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\traning\B1-deepseek.txt",
        "Gemini": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\traning\B1-Gemini.txt",
        #"Microsoft": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\traning\B2-microsoft.txt",
        #"GPT": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\traning\B2-GPT.txt",
    ...
    test_files = {
        "clude": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\test\B2-clude.txt",
        #"Google": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\test\B2-Google.txt",
        "Deepseek": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\test\B2-deepseek.txt",
        "Gemini": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\test\B1-Gemini.txt",
        #"Microsoft": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\test\B2-microsoft.txt",
        #"GPT": r"C:\Users\lulu\OneDrive - Debark University\Documents\english-amharic by computer transaltors\AI-translator\A-E\test\B2-GPT.txt",
    ...
    training_data_map = {
        author: load_text(file_path, 90) for author, file_path in training_files.items()
    }

    # Load test slices (16 slices per file, 4 kB each)
    test_slices = {
        author: load_test_slices(file_path, num_slices=32, slice_size_kb=2) for author, file_path in test_files.items()
    }
